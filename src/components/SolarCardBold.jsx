...
export const SolarCardBold = ({ className = "" }) => (
  <IconBox className={className} innerW={24} innerH={18} opticalScale={1}>
    <defs>
      <mask id="cardMask">
        <g fill="none">
          <path
    ...
    <path fill="currentColor" d="M0 0h24v24H0z" mask="url(#cardMask)" />
  </IconBox>
);
